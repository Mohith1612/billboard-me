...
| Testing | Repeatable behavior/migration/browser checks | Static checks plus targeted client-boundary, environment-contract and disposable waitlist database/route scripts | Partial | No general test runner, Playwright or CI; FOUNDATION-003/004 own those layers |
