...
| No general test suite or CI | Targeted waitlist and environment shell/SQL checks exist; no Vitest/Playwright/general harness/workflow | P0 FOUNDATION-003/004 | Repeatable broader behavior tests and passing PR CI |
