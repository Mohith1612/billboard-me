...
- Verify deployed auth, private participant/evidence records, webhook signature/retry, inventory-hold expiry and normal-settlement reconciliation. Test native media if enabled; do not require proof-controlled funds holds.
