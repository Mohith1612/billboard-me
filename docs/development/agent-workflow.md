...
2. Verify dependencies are human-merged/accepted with evidence. The [backlog](../status/backlog.md) is topologically ordered and the [roadmap](../status/roadmap.md) shows independent lanes. FOUNDATION-001 merged in PR #53. FOUNDATION-002 (#5) has open PR #54; finish that issue through review/fixes and founder merge rather than duplicating it. Dependent harness work waits for that merge.
